            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-slate-300 text-lg leading-relaxed">
                  Система Xishan DK-B-MS обеспечивает удаление фиброаденом и других образований через прокол 2-3 мм. Процедура проходит под местной анестезией, занимает всего 15-20 минут и не оставляет шрамов. Высокая точность благодаря регулировке размера апретуры с шагом 1мм и вакуумному контролю гарантирует безопасность.
                </p>
