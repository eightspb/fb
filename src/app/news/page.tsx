...
export const metadata: Metadata = {
  title: "Новости",
  description: "Новости и события компании FB.NET: конференции, выставки, обучение, новое оборудование, партнерство с заводом Сишань. Будьте в курсе последних событий.",
};
